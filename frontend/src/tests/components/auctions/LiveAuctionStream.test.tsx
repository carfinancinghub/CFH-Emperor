...
Version: 1.1
Description: Jest tests for LiveAuctionStream component with ≥95% coverage including
             accessibility (jest-axe) and WebSocket mocks.
Purpose: Jest tests for LiveAuctionStream.tsx with ≥95% coverage, including accessibility
         (jest-axe) and WebSocket mocks.
    ...
    await waitFor(() => {
      ...
      expect(toast.error).toHaveBeenCalledWith(
        expect.stringContaining(
          'Stream error for auction123: Network error.',
        ),
      );
    });
  });
