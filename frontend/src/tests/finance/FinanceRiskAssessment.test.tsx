// Converted from FinanceRiskAssessment.test.jsx â€” 2025-08-22T18:13:12.398472+00:00
...
describe('FinanceRiskAssessment', () => {
  ...
  it('shows error message on failure', async () => {
    ...
    fetchRiskScores.mockImplementationOnce(() =>
      Promise.reject(new Error('Failed')),
    );
    render(<FinanceRiskAssessment auctions={mockAuctions} />);
    await waitFor(() => {
      expect(
        screen.getByText(/Unable to load risk analytics/i),
      ).toBeInTheDocument();
    });
  });
});
